      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="min-[1281px]:hidden">
            <div className="flex overflow-x-auto scroll-smooth snap-x snap-mandatory gap-3 [scrollbar-none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
              {visibleSuggestions.map((suggestion) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm leading-5 text-slate-600 dark:text-slate-100 flex-1 min-w-0">
                      {suggestion.text}
                    </p>
                    ...
                    <button
                      ...
                      className="p-1 rounded-full text-slate-300 dark:text-slate-500 hover:text-slate-400 shrink-0 transition-colors"
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-600">
              {visibleSuggestions.map((suggestion) => (
                ...
                >
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-100 flex-1 min-w-0">
                    {suggestion.text}
                  </p>
                  ...
                  <button
                    type="button"
                    onClick={() => handleDismiss(suggestion.conditionKey)}
                    className="p-1 rounded-full hover:text-slate-400 text-slate-300 dark:text-slate-500 shrink-0 transition-colors"
                    aria-label="Tutup saran ini"
                  >
                    <X size={14} />
                  </button>
